  ...
  },
  {
    ...
    extraSchema: JSON.stringify({
      ...
      'step': [
        ...
        { '@type': 'HowToStep', 'position': 5, 'name': 'Provide Initial Cost Details', 'text': 'Enter your adoption or purchase fee, decide on pet insurance, training plans, and initial vet care budget. We use breed averages if you do not have exact figures.', 'url': `${BASE_URL}/` },
