        ...
        <div className="container mx-auto px-4 py-12 max-w-4xl">
          ...
          <section className="mb-12">
            ...
            <p className="text-foreground/90 leading-relaxed">
              ...
              We do not guarantee that all information is up-to-date or error-free.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className="text-foreground/90 leading-relaxed mb-4">
              To support our operations, we display advertisements through Google AdSense.
              These ads are clearly marked. We are not responsible for the content of
