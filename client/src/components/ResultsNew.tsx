...
import { type CalculatorInputs, type CostBreakdown, getBreedById } from '@/lib/calculator';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-secondary/5">
      ...
      <div className="container max-w-6xl" data-pdf-export>
        ...
        {/* Currency Selector */}
        <div className="flex justify-center items-center gap-3 mb-8 p-4 bg-muted/30 rounded-lg flex-wrap">
          <Globe className="w-5 h-5 text-muted-foreground" />
          <span className="text-sm font-medium text-muted-foreground">Display costs in:</span>
          <CurrencySelector />
          <span className="text-xs text-muted-foreground ml-2">Exchange rates are approximate</span>
        </div>
