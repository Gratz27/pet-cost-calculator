  ...
  return (
    <div className="card p-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input type="text" name="name" placeholder="Your name" value={fields.name} onChange={handleChange} required className="input-field" />
        <input type="email" name="email" placeholder="Your email" value={fields.email} onChange={handleChange} required className="input-field" />
        <select name="topic" value={fields.topic} onChange={handleChange} required className="input-field">
        ...
        <textarea name="message" placeholder="Your message..." rows={4} value={fields.message} onChange={handleChange} required className="input-field resize-none" />
        {status === "error" && (
          <p className="text-sm text-red-600">Something went wrong — please email us at hello@petcost-calculator.com</p>
        )}
