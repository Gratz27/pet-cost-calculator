            ...
            return (
              <Link key={breed.id} href={`/breeds/${breed.id}`} className="card overflow-hidden group hover:border-[#4CAF50]/50">
                <div className="relative h-52 bg-[#E8F5E9] overflow-hidden">
                  <BreedImage breedId={breed.id} petType={petType} alt={breed.name} fill className="object-cover object-center group-hover:scale-105 transition-transform duration-300" sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 25vw" />
                </div>
                <div className="p-4">
